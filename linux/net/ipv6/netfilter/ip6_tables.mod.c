...
__used __section("__versions") = {
	...
	{ 0x22446a00, "xt_compat_match_to_user" },
	{ 0xdcb764ad, "memset" },
	...
	{ 0xd95233cb, "xt_compat_match_from_user" },
...
MODULE_INFO(srcversion, "5F2EF94870848151D1CB27B");
