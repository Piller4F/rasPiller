...
__used __section("__versions") = {
	...
	{ 0x97f98a8c, "dp_aux_dp_driver_unregister" },
	{ 0xa1584084, "mipi_dsi_driver_register_full" },
	{ 0x7e53acd5, "__dp_aux_dp_driver_register" },
	{ 0x81cbe3cb, "__platform_driver_register" },
	{ 0x8d766886, "mipi_dsi_attach" },
	{ 0xbb76c120, "of_match_node" },
	{ 0xd0272971, "drm_panel_dp_aux_backlight" },
...
MODULE_INFO(srcversion, "BC50B52C55E319B043AC7B7");
