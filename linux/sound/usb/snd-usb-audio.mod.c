...
__used __section("__versions") = {
	...
	{ 0xda4662b4, "usb_disable_autosuspend" },
	{ 0xdd64e639, "strscpy" },
	{ 0x3c3ff9fd, "sprintf" },
	...
	{ 0x77e1052f, "snd_pcm_period_elapsed_under_stream_lock" },
	{ 0x53ddc622, "snd_device_new" },
	{ 0x461ccb2f, "usb_string" },
	{ 0xc4e7c29, "media_remove_intf_link" },
	...
	{ 0xa7d381c8, "usb_pipe_type_check" },
...
MODULE_INFO(srcversion, "D0B9A38A97B680B7F2CBBEC");
